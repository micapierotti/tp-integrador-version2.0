...
public class Datos {
	...
	public Datos() {
		...
		Ruta r1= new Ruta(10,60,40,acopioPuerto,acopioFinal);
		Ruta r2= new Ruta(5,20,20,acopioPuerto,p1);
		Ruta r3= new Ruta(6,22,20,acopioPuerto,p2);
		Ruta r4= new Ruta(14,180,40,p3,acopioFinal);
		Ruta r5= new Ruta(20,170,60,p2,acopioFinal);
