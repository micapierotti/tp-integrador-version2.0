...
public class CaminoPlantaInicial {
	...
	public CaminoPlantaInicial(Datos datos) {
		this.datos=datos;
		initialize();
	}
	...
	private void initialize() {
		...
		lblIngreseLosDatos = new JLabel("Ingrese la planta incial del camino ");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new CaminoPlantaFinal(planta,datos);
				frame.dispose();
			}
		});
